      ...
      <form className="md:col-span-2">
        <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
          ...
          <div className="col-span-full">
            ...
            <div className="mt-2">
              <div className="flex rounded-md bg-gray/5 ring-1 ring-inset ring-gray/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
                ...
                <input
                  ...
                  className="flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray focus:ring-0 sm:text-sm sm:leading-6"
                  placeholder="dominik"
                />
              </div>
            </div>
          ...
          <div className="col-span-full">
            ...
            <div className="mt-2">
              <select
                id="timezone"
                name="timezone"
                className="block w-full rounded-md border-0 bg-gray/5 py-1.5 text-gray shadow-sm ring-1 ring-inset ring-gray/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6 [&_*]:text-black"
              >
